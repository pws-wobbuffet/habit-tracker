...
export function SideNav() {
  return (
    <aside className="hidden md:flex flex-col w-56 shrink-0 bg-surface border-r border-black/5 h-full">
      <div className="px-5 py-6">
        <span className="font-display text-xl font-semibold text-text">Habitus</span>
      </div>
